...
import { MapPin, Calendar, Star, ArrowRight, DollarSign, ArrowLeft } from 'lucide-react';
...
const MyEvents = async ({ searchParams }: PageProps) => {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {events.map((event) => (
                        <div
                            key={event.id}
                            className="rounded-3xl bg-white/70 backdrop-blur-lg shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300 "
                        >
